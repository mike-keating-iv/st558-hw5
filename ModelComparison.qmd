...
-    When fitting a multiple linear regression model, what does adding an interaction term
    ...
    Adding an interaction term accounts for the situation where the value of one predictor can depend on the value of another predictor. This is represented in the formula as a product of these terms.
